...
export default function Footer() {
  ...
  return (
    <footer className="bg-radical-light dark:bg-radical-dark border-t border-radical-primary-light/20 dark:border-radical-primary-DEFAULT/20 pt-16 pb-8 relative">
      <div className="absolute inset-0 radical-grid-light dark:radical-grid opacity-30 pointer-events-none cyberpunk-grid"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              <div className="flex items-center space-x-2 mb-6">
                <div className="relative w-10 h-10 border border-radical-primary-light dark:border-radical-primary-DEFAULT flex items-center justify-center overflow-hidden industrial-border">
                  <div className="absolute inset-0 radical-grid-light dark:radical-grid opacity-30"></div>
                  <span className="text-radical-primary-light dark:text-radical-primary-DEFAULT font-tech text-xl font-bold z-10">M</span>
            ...
            <div>
              <h3 className="gothic-title text-lg text-radical-dark dark:text-radical-light mb-6">NAVIGATION</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.href}>
                    <Link 
                      href={link.href}
                      className="tech-text text-sm text-radical-dark/70 dark:text-radical-light/60 hover:text-radical-primary-light dark:hover:text-radical-primary-DEFAULT transition-colors"
                    >
                      <span className="num-tag mr-2 text-radical-primary-light dark:text-radical-primary-DEFAULT">0{index + 1}</span> {link.label}
                    </Link>
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <div className="mt-6">
                {/* Collaborate/Contact link removed */}
              </div>
            </div>
          </div>
